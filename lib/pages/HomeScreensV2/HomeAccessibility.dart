...
class HomeAccessibility extends StatefulWidget {
  final Color primaryColor;
  const HomeAccessibility({key, this.primaryColor});

  @override
  _HomeAccessibilityState createState() => _HomeAccessibilityState();
}

class _HomeAccessibilityState extends State<HomeAccessibility> {
  @override
  Widget build(BuildContext context) {
    return SafeArea(
      child: Scaffold(
        appBar: AppBar(
          title: WidgetAppBar("Accessibility"),
          actions: [
            PopupMenuButton(
