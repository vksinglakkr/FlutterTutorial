...
class Que06Overflow extends StatefulWidget {
  @override
  _State createState() => new _State();
}

class _State extends State<Que06Overflow> {
  @override
      ...
      body: Container(
        ...
        child: ListView(
          children: [
            ...
            Text(
                'Normal Text =>Kurukshetra has been described in the first verse of Shrimad bhagvadgita, in the form of Dharmakshetra Kurukshetra. Kurukshetra is a place of great historical and religious significance which is seen with reverence in all the countries due to its association with Vedas and Vedic culture. This is the land on which the battle of Mahabharata was fought and Lord Krishna gave Arjuna a fair knowledge of the philosophy of karma in the Jyotisar. '),
            SizedBox(height: 10),
            Row(children: [
              SizedBox(
                width: 100,
            ...
            SizedBox(height: 10),
            Text(
                'What clip do=>it will warp the text sharply at end instead of softly.'),
            SizedBox(height: 10),
            Text(
              'softWrap:false Text Largeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee',
              overflow: TextOverflow.fade,
              softWrap: false,
            ),
          ],
