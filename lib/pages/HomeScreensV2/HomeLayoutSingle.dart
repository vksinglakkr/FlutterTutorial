...
class HomeLayoutSingle extends StatefulWidget {
  final Color primaryColor;
  const HomeLayoutSingle({key, this.primaryColor});

  @override
  _HomeLayoutSingleState createState() => _HomeLayoutSingleState();
}

class _HomeLayoutSingleState extends State<HomeLayoutSingle> {
  @override
  Widget build(BuildContext context) {
    return SafeArea(
      child: Scaffold(
        appBar: AppBar(
          title: WidgetAppBar("Layout-Single Child"),
          actions: [
            PopupMenuButton(
